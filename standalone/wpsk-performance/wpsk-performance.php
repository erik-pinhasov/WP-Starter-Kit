<?php
/**
 * Plugin Name:       WP Starter Kit: Performance Optimizer
 * Plugin URI:        https://github.com/YOUR_USERNAME/wpsk-performance
 * Description:       Remove WordPress bloat and optimize loading.
 * Version:           1.1.0
...
if ( defined( 'WPSK_SUITE_ACTIVE' ) ) {
	add_action( 'admin_notices', function () {
		...
		esc_html_e( 'WP Starter Kit: Performance Optimizer — the full suite is active, so this standalone version has been skipped. You can safely deactivate it.', 'wpsk-performance' );
		echo '</p></div>';
	} );
	return;
}
